...
class PhysicsInformedNN:
    ...
    def __init__(self, x0, u0, x1, layers, dt, lb, ub, q):
        ...
        # Load IRK weights
        tmp = np.float32(np.loadtxt('C:\\Users\\LENOVOO\\PycharmProjects\\pythonProject5\\Butcher_IRK100.txt',  ndmin=2))
...
if __name__ == "__main__":
    ...
    data = scipy.io.loadmat('C:\\Users\\LENOVOO\\PycharmProjects\\pythonProject5\\AC.mat')
    ...
    bplot, = ax.plot(x, Exact[idx_t1, :], 'b-', linewidth=2, label='Exact')
    rplot, = ax.plot(x_star, U1_pred[:, -1], 'r--', linewidth=2, label='Prediction')

    ax.legend(handles=[bplot, rplot], labels=['Exact', 'Prediction'], loc='upper center', bbox_to_anchor=(0.8, -0.3),
